...
INSERT INTO cars (id, gos_nomber, height, length, max_people_capacity, max_weight, price_per_hour, size, width) VALUES
(1, 'Р123ОМ123', 2.7, 3.5, 5, 5000, 2000, 15, 2),
(2, 'К325ОТ777', 3, 6, 5, 9000, 3000, 25, 2.5);
